  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        Next <span className="text-purple">level</span>
      </h1>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <p
          className="text-white text-center text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10  mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200"
          style={{ color: "#e4ecff" }}
        >
          {description}
        </p>
