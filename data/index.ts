...
export const gridItems = [
  {
    id: 1,
    title: "Cenię sobie bliską współpracę z klientami.",
    description: "",
  ...
  {
    id: 2,
    title: "Stworzymy dla Ciebie rozwiązania nie z tej ziemi!",
    description: "",
  ...
  {
    id: 3,
    title: "Łącząc technologie",
    description: "Tworzymy projekty",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Komunikacja jest jasna i otwarta.",
    description: "",
  ...
  // {
  //   id: 5,
  //   title: "Rozwiążesz najbardziej zaawansowane problemy",
  //   description: "z nami",
